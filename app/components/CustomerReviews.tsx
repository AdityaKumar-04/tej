...
const reviews: Review[] = [
  {
    ...
    feedback:
      "Tezz Travels made my trip seamless and comfortable. The car was clean, and the driver was very polite. Highly recommend their services!",
  },
  {
    id: 2,
    name: "Priya Singh",
    ...
    feedback:
      "I had an amazing experience with Tezz Travels. Booking was easy, and their support team was very helpful. Great service!",
  },
  {
    id: 3,
    name: "Rahul Verma",
    ...
    feedback:
      "Affordable prices and excellent service! I will definitely choose Tezz Travels for my future trips. Thank you!",
  },
];
