...
const ActivitiesWidget = () => {
  ...
  const activities = [
    ...
    {
      img: '/assets/reviews/7.JPG',
      title: 'Taj Mahal, Agra, India',
      description: 'Tej Travels made our Taj Mahal visit stress-free. The cab arrived promptly, and the driver was very courteous.',
    },
    {
      img: '/assets/reviews/8.JPG',
      title: 'Taj Mahal, Agra, India',
      description: 'Tej Travels made our Taj Mahal visit stress-free. The cab arrived promptly, and the driver was very courteous.',
    },
    {
      img: '/assets/reviews/9.JPG',
      title: 'Taj Mahal, Agra, India',
      description: 'Tej Travels made our Taj Mahal visit stress-free. The cab arrived promptly, and the driver was very courteous.',
    },
    {
      img: '/assets/reviews/10.JPG',
      title: 'Taj Mahal, Agra, India',
      description: 'Tej Travels made our Taj Mahal visit stress-free. The cab arrived promptly, and the driver was very courteous.',
    },
    {
      img: '/assets/reviews/11.PNG',
      title: 'Taj Mahal, Agra, India',
      description: 'Tej Travels made our Taj Mahal visit stress-free. The cab arrived promptly, and the driver was very courteous.',
    },
  ];
  ...
  return (
    <div className={`${styles.widget } p-[25px]`}>
