  ...
  return (
    <div className="container-blogs mx-auto p-6">
      <div className="max-w-4xl mx-auto overflow-hidden">
        <div className="w-full mt-20 border-gray-500 p-2 rounded ">
          <img
            src={blog.image}
            alt={blog.title}
            className="w-full object-cover rounded-xl shadow-md shadow-black"
          />
        </div>
        <div className="p-6">
          ...
          <div className="mt-6 flex justify-between items-center text-gray-600">
            ...
            <button onClick={()=> router.push("/")} className="text-indigo-600 hover:underline cursor-pointer">
              Back to Blogs
            </button>
          </div>
        </div>
